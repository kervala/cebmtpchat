...
SET(_COMPILERS MSVC60 MSVC70 MSVC71 MSVC80 MSVC90 MSVC10 MINGW CYGWIN ANDROID IOS)

FOREACH(_COMPILER ${_COMPILERS})
  IF(${_COMPILER})
    SET(ENV_NAME "EXTERNAL_${_COMPILER}_PATH")
    SET(EXTERNAL_COMPILER_PATH $ENV{${ENV_NAME}})
    MESSAGE(STATUS "Found environment variable ${ENV_NAME}")
  ENDIF(${_COMPILER})
