...
MACRO(SET_TARGET_GUI_EXECUTABLE name)
  ...
  ELSE(APPLE)
    ...
    INSTALL(FILES
      "${EXTERNAL_BINARY_PATH}/zlib1.dll"
      "${EXTERNAL_BINARY_PATH}/libeay32.dll"
      "${EXTERNAL_BINARY_PATH}/ssleay32.dll"
      ...
      ELSE(XCODE)
        IF(IOS)
          ...
          IF(CMAKE_IOS_SIMULATOR_SYSROOT AND TARGET_X86)
            IF(TARGETS_COUNT NOT EQUAL 1)
              SET(XARCH "-Xarch_i386 ")
            ENDIF(TARGETS_COUNT NOT EQUAL 1)
...
MACRO(FIND_PACKAGE_HELPER NAME INCLUDE RELEASE DEBUG)
  ...
  IF(NOT WIN32)
    ...
    IF(PKG_CONFIG_FOUND)
      PKG_SEARCH_MODULES(PKG_${NAME_FIXED} ${MODULES})
