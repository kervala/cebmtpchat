...
MACRO(SET_TARGET_LIB name)
  ...
  FOREACH(ARG ${ARGN})
    ...
    ELSEIF(ARG STREQUAL PRIVATE)
      SET(IS_PRIVATE ON)
    ELSEIF(ARG MATCHES "\\.(cpp|mm|m|c|cxx|cc|rc|def)$")
  ...
  IF(IS_STATIC OR IS_SHARED)
    ...
    IF(NOT IS_PRIVATE)
      ...
      IF(IS_STATIC AND NOT IS_SHARED AND WITH_INSTALL_LIBRARIES)
        INSTALL(TARGETS ${name} RUNTIME DESTINATION ${BIN_PREFIX} LIBRARY DESTINATION ${LIBRARY_DEST} ARCHIVE DESTINATION ${LIB_PREFIX})
      ENDIF(IS_STATIC AND NOT IS_SHARED AND WITH_INSTALL_LIBRARIES)
      IF(STATIC_LIB AND WITH_INSTALL_LIBRARIES)
      ...
      ENDIF(STATIC_LIB AND WITH_INSTALL_LIBRARIES)
      ...
      IF(MSVC AND WITH_INSTALL_LIBRARIES)
        ...
        ENDIF(IS_SHARED)
      ENDIF(MSVC AND WITH_INSTALL_LIBRARIES)
    ELSE(NOT IS_PRIVATE)
      IF(IS_SHARED)
