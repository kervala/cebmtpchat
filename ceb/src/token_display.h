...
{
public:
	TokenDisplay() : m_token(Token_Unknown) {}
	TokenDisplay(MtpToken token);

	void setToken(MtpToken token);
...
public:
	...
	bool isForcedToken(MtpToken token) const;
	bool isForcedToken(MtpToken token, int arg) const;
	bool isForcedFont(MtpToken token, int arg) const;
	bool isForcedColor(MtpToken token, int arg) const;
	QFont tokenFont(MtpToken token, int arg) const;
	QColor tokenColor(MtpToken token, int arg) const;
	void setTokenFont(MtpToken token, int arg, const QFont &font);
	void setTokenColor(MtpToken token, int arg, const QColor &color);
	void resetTokenFont(MtpToken token, int arg);
	void resetTokenColor(MtpToken token, int arg);
...
private:
	...
	QMap<MtpToken, TokenDisplay> m_tokenDisplays;
